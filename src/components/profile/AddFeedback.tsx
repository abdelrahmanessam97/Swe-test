...
const AddFeedback = () => {
  ...
  const handleSubmit = () => {
    // TODO: Submit feedback data to API
    // Data to submit: { deliveryTime, productQuality, packaging, feedback }
  ...
  return (
    <section>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger className="mt-5 text-primary font-bold border border-[#FAB1A9] px-12 py-2 rounded-md">Add Feedback</DialogTrigger>
        <DialogContent className="!max-w-[600px]">
          <DialogHeader>
            ...
            <div className="flex flex-col gap-4 mt-4">
              <RatingRow label="Delivery Time" value={deliveryTime} onChange={setDeliveryTime} />
              <RatingRow label="Product Quality" value={productQuality} onChange={setProductQuality} />
              <RatingRow label="Packaging & Handling" value={packaging} onChange={setPackaging} />
